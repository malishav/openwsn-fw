...
owerror_t cjoin_receive(QueueEntry_t *msg,
...
void cjoin_sendDone(QueueEntry_t *msg,
                    owerror_t error);
...
void cjoin_sendDone(QueueEntry_t *msg, owerror_t error) {
...
owerror_t cjoin_sendJoinRequest(open_addr_t *joinProxy) {
    ...
    queue_removeAllCreatedBy(COMPONENT_CJOIN);

    // create a CoAP RD packet
    pkt = queue_getFreePacketBuffer(COMPONENT_CJOIN);
    if (pkt == NULL) {
