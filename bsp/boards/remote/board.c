...
void antenna_2_4ghz(void);
void antenna_subghz(void);
 ...
 */
void antenna_init(void) {
    GPIOPinTypeGPIOOutput(BSP_ANTENNA_BASE, BSP_ANTENNA_PIN);

    /* By default the 2.4Ghz RF interface is selected as the default */
    GPIOPinWrite(BSP_ANTENNA_BASE, BSP_ANTENNA_PIN, ~BSP_ANTENNA_PIN);
}

/**
 * Selects the on-board 2.4GHz transceiver over the RP-SMA external connector
 */
void antenna_2_4ghz(void) {
    GPIOPinWrite(BSP_ANTENNA_BASE, BSP_ANTENNA_PIN, ~BSP_ANTENNA_PIN);
}
...
/**
 * Selects the RF CC1200 sub-1GHz transceiver over the RP-SMA external connector
 */
void antenna_subghz(void) {
    GPIOPinWrite(BSP_ANTENNA_BASE, BSP_ANTENNA_PIN, BSP_ANTENNA_PIN);
}
