Zolertia RE-Mote Eclipse project: howto
--------------------------------------
...
Importing RE-Mote project:
---------------------------------

- Go into ${openwsn-fw}/projects/remote and create a copy of the Eclipse-format folder
...
- Select root directory and Browse to ${openwsn-fw}/projects/remote/OPENWSNECLIPSE and press Finish
