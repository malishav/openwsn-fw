...
*/
owerror_t IEEE802154_security_prependAuxiliarySecurityHeader(QueueEntry_t *msg) {
...
*/
owerror_t IEEE802154_security_outgoingFrameSecurity(QueueEntry_t *msg) {
    uint8_t nonce[13];
    uint8_t *key;
    owerror_t outStatus;
    uint8_t *a;
...
*/
void IEEE802154_security_retrieveAuxiliarySecurityHeader(QueueEntry_t *msg, ieee802154_header_iht *tempheader) {
...
*/
owerror_t IEEE802154_security_incomingFrame(QueueEntry_t *msg) {
    uint8_t nonce[13];
    owerror_t outStatus;
    uint8_t *a;
    uint8_t len_a;
...
uint8_t IEEE802154_security_getSecurityLevel(QueueEntry_t *msg) {
...
bool IEEE802154_security_acceptableLevel(QueueEntry_t *msg, ieee802154_header_iht *parsedHeader) {
    if (IEEE802154_security_isConfigured() == FALSE &&
