...
#define FRAGMENT_BUFFER_SIZE        (((IPV6_PACKET_SIZE / MAX_FRAGMENT_SIZE) + 1) * BIG_QUEUE_LENGTH)
#define NUM_OF_VRBS                 2
#define NUM_OF_CONCURRENT_TIMERS    (NUM_OF_VRBS + BIG_QUEUE_LENGTH)
...
struct fragment_t {
    ...
    QueueEntry_t *pFragment;
    QueueEntry_t *pOriginalMsg;
};
END_PACK
