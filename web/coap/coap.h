...
#define OSCORE_MAX_ID_LEN              10

#define OSCOAP_MASTER_SECRET_LEN       16

#define OSCORE_OPT_MAX_LEN             1 + 2 + 1 + OSCORE_MAX_ID_LEN + OSCORE_MAX_ID_LEN
...
typedef struct {
    ...
    uint8_t idContext[OSCORE_MAX_ID_LEN];
...
typedef owerror_t (*callbackRx_cbt)(QueueEntry_t *msg,
                                    coap_header_iht *coap_header,
                                    coap_option_iht *coap_incomingOptions,
                                    coap_option_iht *coap_outgoingOptions,
                                    uint8_t *coap_outgoingOptionsLen);

typedef void (*callbackSendDone_cbt)(QueueEntry_t *msg, owerror_t error);
...
uint8_t coap_options_encode(QueueEntry_t *msg,
                            coap_option_iht *options,
                            uint8_t optionsLen,
